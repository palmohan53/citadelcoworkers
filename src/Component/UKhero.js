...
export default function HeroSectionuK() {
  const settings = {
    dots: false,
        ...
        <div className="container">
          <div className="talent-heading">
           ...
           Build Your Finance & Accounting Team <br />
            ...
            <p>
             Access top 3% finance & accounting talent from India for all your end-to-end accounting requirements <span className="highlight-color"><b>starting at £5/hr.</b></span>
              <br />
