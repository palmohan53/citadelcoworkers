...
.cardA .specialistCardInner {
  animation-duration: 4.8s;
}

.cardB .specialistCardInner {
  animation-duration: 5.4s;
  animation-delay: .35s;
}

.cardC .specialistCardInner {
  animation-duration: 5s;
  animation-delay: .15s;
}

.cardD .specialistCardInner {
  animation-duration: 5.6s;
  animation-delay: .45s;
}

.cardE .specialistCardInner {
...
.cardB {
 ...
 body.hide-header header , body.hide-header footer, body.hide-header .copyright {
    display: none;
}
      `}</style>
        ...
        <div className="container">
          ...
          <span>
            ...
            <b>QuickBooks </b>
              ...
              <a className="heroCta" href="/"  onClick={(e) => {
    e.preventDefault();
    scrollToForm();
  }}>
              ...
              <div className="heroNote">
                 Limited Spots Available. From $7/hr after trial
              </div>
            </div>
