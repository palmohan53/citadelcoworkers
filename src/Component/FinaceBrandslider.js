...
export default function FinanceBrandslider() {
  ...
  const logos = [
    ...
    ,
    {
      src: "https://virtualassistant24x7.com/wp-content/uploads/2026/04/Business-Insider-Logo-2.webp",
    ...
    },
    {
     ...
     ,
    {
      src: "https://virtualassistant24x7.com/wp-content/uploads/2026/04/times-logo.png",
      alt: "Times",
      Image: ""
    }
     ,
    {
      src: "https://virtualassistant24x7.com/wp-content/uploads/2026/01/Deccan_Herald_logo.png",
      alt: "Deccan Herald",
      Image: ""
    }
  ];
            ...
            <div className="fi-track">
              {[...logos, ...logos].map((logo, idx) => (
                <div
                  ...
                  style={{
                    cursor: logo.Image ? "pointer" : "default",
                    opacity: logo.Image ? 1 : 0.6
                  }}
                >
