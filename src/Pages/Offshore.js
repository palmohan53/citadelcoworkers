...
<div className="offshore-page">
  ...
  <div class="container">
    ...
    <p class="desc">
  Scale faster with your extended team in India, without the operational complexity.<br></br> Focus on growth while we handle the setup for long-term success.
    ...
    <div class="buttons">
      <a href="/contact-us" class="btn primary">Send Your Requirements →</a>
...
<div className="flow-item"><div className="flow-number">06</div>
<h4>Quick team setup with minimal onboarding time
